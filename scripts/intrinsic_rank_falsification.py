...
def main():
    ...
    parser.add_argument("--synthetic",type=Path,default=Path("data/stimuli_prospective_synthetic.json"))
    parser.add_argument("--new-carriers",type=Path,default=Path("data/stimuli_prospective_profile_paraphrase.json"))
