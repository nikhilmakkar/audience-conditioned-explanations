...
real=build_examples(load_stimuli(ROOT/"stimuli_domain_matched_8.json"))
sets={"real_test":[e for e in real if e["split"]=="test"],
      "synthetic":build_examples(load_stimuli(ROOT/"stimuli_prospective_synthetic.json")),
      "new_carriers":build_examples(load_stimuli(ROOT/"stimuli_prospective_profile_paraphrase.json"))}
